                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="personal">
                        ...
                        <form class="register-form" id="personal_register_form" action="" method="post">
                            ...
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">英文姓名</label>
                                <input class="form-control placeholder-no-fix" type="text" placeholder="英文姓名" name="en_name" />
                            </div>
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">身份證字號</label>
                                <input class="form-control placeholder-no-fix" type="text" placeholder="身份證字號" name="idno" id="idno" maxlength="10" />
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label visible-ie8 visible-ie9">發證日期 年</label>
                                        <select name="id_card_year" class="form-control">
                                            <option value="">發證日期 年</option>
                                            <?php for ($y = 2004; $y <= date('Y'); $y++): 
                                                    $year = $y - 1911;
                                            ?>
                                                <option value="<?= $y ?>"><?= $year ?>年</option>
                                            <?php endfor; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label visible-ie8 visible-ie9">出發證日期 月</label>
                                        <select name="id_card_month" class="form-control">
                                            <option value="">發證日期 月</option>
                                            <?php for ($m = 1; $m <= 12; $m++): ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label visible-ie8 visible-ie9">發證日期 日</label>
                                        <select name="id_card_day" class="form-control">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label visible-ie8 visible-ie9">發證地點</label>
                                        <select name="id_card_place" class="form-control">
                                            <option value="">請選發證地點</option>
                                            <?php foreach ($places as $value=>$name): ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control placeholder-no-fix" type="text" placeholder="行動電話, ex:09xx-xxxxxx" name="mobile" />
                            </div>

                            <div class="form-group">
                                <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                                <label class="control-label visible-ie8 visible-ie9">電子郵件</label>
                                <input class="form-control placeholder-no-fix" type="text" placeholder="電子郵件, ex:xxxxx@gmail.com" name="email" />
                            </div>

                            <p class="hint"> 請填寫您的預設管理者資訊: </p>
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">管理帳號</label>
                                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="管理帳號 (英數混合、最長請勿超過20個字元。可接受'_')" name="username" id="username" /> </div>
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">管理密碼</label>
                                <input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="register_password" placeholder="管理密碼 (6~20個英數混合字元)" name="password" maxlength="20" /> </div>
                            <div class="form-group">
                    ...
                    <div class="tab-pane" id="enterprise">
                        ...
                        <form class="register-form" id="enterprise_register_form" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control placeholder-no-fix" type="text" placeholder="公司電話, ex:0x-xxxxxx or 09xx-xxxxxx" name="tel" />
                            </div>
                            <p class="hint"> 請填寫您的預設管理者資訊: </p>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">管理者英文姓名</label>
                                <input class="form-control placeholder-no-fix" type="text" placeholder="管理者英文姓名" name="en_name" />
                            </div>
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">管理者電子郵件</label>
                                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="管理者電子郵件, ex:xxx@abc.com" name="email" />
                            </div>
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">管理者行動電話</label>
                                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="管理者行動電話, ex:09xx-xxxxxx" name="mobile" />
                            </div>

                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">管理帳號</label>
                                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="管理帳號 (英數混合、最長請勿超過20個字元。可接受'_')" name="username" id="e_username" />
                            </div>
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">管理密碼</label>
                                <input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="enterprise_register_password" placeholder="管理密碼 (6~20個英數混合字元)" name="password" />
                            </div>
                            <div class="form-group">
                                <label class="control-label visible-ie8 visible-ie9">確認管理密碼</label>
